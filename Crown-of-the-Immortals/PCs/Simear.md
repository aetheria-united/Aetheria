...
## Family
- **Mother**: [Ethear](../../World/Characters/Ethear.md), a cloud dragon.
- **Father**: [Tal’im Ran’dir](../../World/Characters/Tal’im-Ran’dir.md), an adventurer.

Simear’s mother, [Ethear](../../World/Characters/Ethear.md), was a cloud dragon. His father, [Tal’im Ran’dir](../../World/Characters/Tal’im-Ran’dir.md), was part of an adventuring party that stumbled upon [Ethear](../../World/Characters/Ethear.md)’s lair in the mountains. Initially, [Ethear](../../World/Characters/Ethear.md) captured and held the adventurers, assuming they were of ill intent. Over time, [Tal’im](../../World/Characters/Tal’im-Ran’dir.md) developed Stockholm syndrome and eventually won [Ethear](../../World/Characters/Ethear.md)’s affection, leading to the release of the remaining adventurers. [Tal’im](../../World/Characters/Tal’im-Ran’dir.md) chose to stay with [Ethear](../../World/Characters/Ethear.md), resulting in Simear’s birth.
...
Simear demonstrated an aptitude for building things at an early age. His father, [Tal’im](../../World/Characters/Tal’im-Ran’dir.md), sought out craftsmen to employ Simear when they lived with the elves. However, this was never for more than a couple of months at a time, as the family frequently went on adventures and visited dragons. In his mid-twenties, Simear met a group of merchants and, with his parents’ blessing, left to work as both a traveling smithy and a member of the caravan guard.
...
- **Friend**: [Karsten](../PCs/Karsten-Kendrick.md)
  - **Nature**: Ally and potential friend.
  - **Interaction**: They met during a heated discussion among members of [Karsten](../PCs/Karsten-Kendrick.md)’s order. [Karsten](../PCs/Karsten-Kendrick.md)’s warnings of imminent cataclysmic destruction resonated with Simear’s distrust of organized religion, leading to their alliance.
  - **Status**: Busy with their respective organizations, [Karsten](../PCs/Karsten-Kendrick.md) might not remember Simear well.
- **Rivals**:
  - **Names**: [Elanil](../../World/Characters/Elanil.md) and [Faelar](../../World/Characters/Faelar.md)
  ...
  - **Status**: Likely remained in their elven community, possibly affected by the [Flaming Retribution](../../World/Events/The-Flaming-Retribution.md).
...
> Simear’s mother was a cloud dragon named [Ethear](../../World/Characters/Ethear.md). His father’s adventuring party stubbled upon her as they worked their way across a high ridge of some mountains. The party was a motley crew of some rather unsavory species. She assumed them to be of ill intent when they stumbled into her eire. She ensnared them, holding them captive for several months eating most of his company. During this time his father (Tal’im Ran’dir) began to suffer from Stockholm’s syndrome. She slowly succame to his charm and apparent sincere affection for her. She released the remaining prisoners, but he refused to leave with the remnants of his party.
...
### What did your character do before The [Flaming Retribution](../../World/Events/The-Flaming-Retribution.md)? 
>Simear demonstrated an aptitude for building things at an early age. When he lived with the elves, [Tal’im](../../World/Characters/Tal’im-Ran’dir.md) sought out craftsmen to employ Simear. This was never for more than a couple months at a time as the family would go on adventures and visit the dragons. When Simear was in his mid-twenties he met a group of merchants and with the blessing of his mother and father left in their employ as both a traveling smithy as well as a member of the guard for the caravan.
...
>***Friend***: [Karsten](../PCs/Karsten-Kendrick.md). They met when a heated discussion broke out on the street among members of [Karsten](../PCs/Karsten-Kendrick.md)’s order. They began forcefully removing people from the temple for repeating warnings about an imminent cataclysmic destruction. This caught Simear’s attention. His natural distrust for the organized religious structure helped make for a sympathetic ear when [Karsten](../PCs/Karsten-Kendrick.md) began explaining the situation. This began the inner troublings that led Simear to persuade the caravan to follow [Karsten](../PCs/Karsten-Kendrick.md)’s sect to the North. While Simear would consider [Karsten](../PCs/Karsten-Kendrick.md) a friend or at least an ally, he acknowledges that [Karsten](../PCs/Karsten-Kendrick.md) probably has since forgotten Simear. Each has been very busy trying to get their respective organizations moved and settled.
...
>Not sure if the elven community is within the geographic region of the [Flaming Retribution](../../World/Events/The-Flaming-Retribution.md). But they would not be likely to leave their community and beloved lands.
